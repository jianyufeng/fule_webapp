...
define(['linq'], function () {
    ...
    locationInfo.getProvince = function () {
        ...
        if (locationData != null) {
            ...
            var exampleArray = JSLINQ(locationData).Where(function (item) {
                return item.region_type == "1";
            })
    ...
    locationInfo.getAddressName = function (pid, cid, aid) {
        ...
        if (locationData != null) {
            ...
            var pname = JSLINQ(locationData).Where(function (item) {
                return item.region_id == pid;
            })
            var cname = JSLINQ(locationData).Where(function (item) {
                return item.region_id == cid;
            })
            var aname = JSLINQ(locationData).Where(function (item) {
                return item.region_id == aid;
            })
